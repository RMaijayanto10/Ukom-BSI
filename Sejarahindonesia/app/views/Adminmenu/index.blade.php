         ...
         <div class="metro span12">
            <div class="metro-sections">
               ...
               <div id="section1" class="metro-section tile-span-4">
                  ...
                  <a class="tile wide imagetext bg-color-darken" href="{{URL::to("Registration")}}" />
                     <div class="image-wrapper">
                        <img src="images/metro-tiles.jpg" />
                     </div>
                     <div class="column-text">
                        <div class="text4">Registration</div>
                     </div>
                     <div class="app-label">Create New Admin</div>
                  </a>
   
                  <a class="tile wide imagetext wideimage bg-color-red" href="{{URL::to("Sejarahibukota")}}">
                  ...
                  <a class="tile app bg-color-pink" href="{{URL::to("")}}">
                     <div class="image-wrapper">
                  ...
                  <a class="tile app bg-color-greenDark" href="{{URL::to("")}}">
                     <div class="image-wrapper">
            ...
            <a class="tile half bg-color-greenDark" data-click="transform" href="{{URL::to("Presidensoekarno")}}">
                <div class="tile-content icon">
                    <img src="images/Soekarno.jpg">
                </div>
            </a>
            <a class="tile half bg-color-greenDark" data-click="transform" href="{{URL::to("Presidensoeharto")}}">
                <div class="tile-content icon">
                    <img src="images/Soeharto1.jpg">
                </div>
            </a>
            <a class="tile half bg-darkPink" data-click="transform" href="{{URL::to("Presidenhabibi")}}">
                <div class="tile-content icon">
                    <img src="images/BjHabibi.jpg">
                </div>
            </a>
            <a class="tile half bg-orange" data-click="transform" href="{{URL::to("Presidengusdur")}}">
                <div class="tile-content icon">
