         ...
         <div class="metro span12">
            <div class="metro-sections">
               ...
               <div id="section1" class="metro-section tile-span-5">
                   <form method="post">
                        <img src="images/Sumsel.png"/><br />
                        <textarea class="ckeditor" name="teks"></textarea>
                         <div class="alert alert-danger"> 
                            {{ $errors->first('teks') }}</div>
                        <div align="right"><br />
                        <a href="{{URL::to("Sumateraselatan")}}"><button class="btn">Add</button></a>
                        </div>
                    </form><br /><br />
                    ...
                    <tr>
                      ...
                      <td width="250" height="21" align="center" valign=" "bottomnowrap="nowrap" class="text-center">
                        <a href="{{URL::to("Sumateraselatan/edit/".$tampil->id) }}"><button class="btn">Edit</button></a>
                        <a href="{{URL::to("Sumateraselatan/" .$tampil->id. "/destroy")}}"><button class="btn">Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
