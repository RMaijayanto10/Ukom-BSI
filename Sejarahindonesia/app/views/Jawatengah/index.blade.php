         ...
         <div class="metro span12">
            <div class="metro-sections">
               ...
               <div id="section1" class="metro-section tile-span-4">
                   <form method="post">
                        <img src="images/Semarang.png"/><br />
                        <textarea class="ckeditor" name="teks"></textarea>
                         <div class="alert alert-danger"> 
                            {{ $errors->first('teks') }}</div>
                        <div align="right"><br />
                        <a href="{{URL::to("Jawatengah")}}"><button class="btn">Add</button></a>
                        </div>
                    </form> 
               </div> 
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="{{URL::to("Jawatengah/edit/".$tampil->id) }}"><button class="btn">Edit</button></a>
                        <a href="{{URL::to("Jawatengah/" .$tampil->id. "/destroy")}}"><button class="btn">Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
